...
class SolarWinds:
    ...
    def get_node_id(self, node_name):
        ...
        node_id = self.swis.query(
            "SELECT NodeID, Caption FROM Orion.Nodes WHERE Caption = @caption", caption=node_name
        )
    ...
    def get_node_uri(self, node_name):
        ...
        node_uri = self.swis.query("SELECT Caption, Uri FROM Orion.Nodes WHERE Caption = @caption", caption=node_name)
    ...
    def add_node_to_udt(self, node_name):
        udt_properties = {"NodeID": self.get_node_id(node_name), "Capability": "2", "Enabled": True}
        ...
        udt_properties = {"NodeID": self.get_node_id(node_name), "Capability": "3", "Enabled": True}
    ...
    def add_icmp_echo_ip_sla_operation_to_node(self, node_name, ip_sla_operation_number, ip_sla_name):
        ...
        self.logger.info(
            "add_icmp_echo_ip_sla_operation_to_node - add IP SLA operation to node create results: %s", results
        )
    ...
    def add_custom_poller_by_name(self, node_name, poller_name):
        ...
        poller_properties = {"NodeID": node_id, "customPollerID": custom_poller_id["results"][0]["CustomPollerID"]}
    ...
    def get_group_uri(self, group_name):
        ...
        group_uri = self.swis.query("SELECT Uri FROM Orion.Container WHERE Name = @group_name", group_name=group_name)
    ...
    def get_list_of_interfaces(self, node_name):
        ...
        self.logger.info(
            "get_list_of_interfaces_by_name - list_of_interface_names query results: %s", list_interfaces_names
        )
