...
uri = conn.nodes.get_uri(Caption="UKSHRS-SW-1")
print(f"{uri=}")

node_id = conn.nodes.get_id(Caption="UKSHRS-SW-1")
print(f"{node_id=}")

uri_and_id = conn.nodes.get_uri_and_id(Caption="UKSHRS-SW-1")
print(f"{uri_and_id=}")

new_uri = conn.nodes.get_uri_from_id(node_id)
print(f"{new_uri=}")

new_id = conn.nodes.get_id_from_uri(uri)
print(f"{new_id=}")
